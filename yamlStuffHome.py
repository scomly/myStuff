...
class UtilityToolBoxUI(QtGui.QDialog):
    ...
    def checkAllFunction(self): ## Check all Button
        ...
        with open('/Users/scomly/Desktop/yaml/test.yml', 'w') as outfile:
    ...
    def checkNoneFunction(self): ## Check None Button
        ...
        infile = open('/Users/scomly/Desktop/yaml/test.yml')
        self.inSettings = yaml.load(infile)
        infile.close()
        #print self.inSettings
        for x,y in self.inSettings.iteritems():
